...
public class AdminUserService : IAdminUserService
{
    ...
    public async Task<OperationResult<PaginatedList<AdminUserDto>>> GetUsersAsync(
        string? search,
        long? roleId,
    ...
    {
        var users = await _userRepository.GetUsersAsync(search, roleId, subscriptionPlanId, fromDate, toDate, pageNumber, pageSize, cancellationToken);
